...
def comparatorAtm(p1, p2):
    return _molecule.comparatorAtm(p1, p2)
comparatorAtm = _molecule.comparatorAtm

def comparatorBnd(p1, p2):
    return _molecule.comparatorBnd(p1, p2)
comparatorBnd = _molecule.comparatorBnd

def qsort(base, nitems, size, comparator):
    return _molecule.qsort(base, nitems, size, comparator)
qsort = _molecule.qsort
